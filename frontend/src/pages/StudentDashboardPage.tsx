        ...
        <div className="space-y-8 max-w-7xl">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-surface-border bg-surface-card p-7 shadow-sm">
            <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-600 dark:text-emerald-400 font-semibold mb-3">
                ...
                <div className="mt-5 max-w-sm">
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-xs font-bold text-emerald-500">{data.completionPercentage}%</span>
                  </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/intelligence" className="text-xs text-emerald-500 hover:underline flex items-center gap-1 transition-colors">
              ...
              {quickActions.map((action) => {
                ...
                return (
                  <Link
                    key={action.href}
                    to={action.href}
                    className="group relative overflow-hidden rounded-2xl border border-surface-border bg-surface-card p-5 hover:border-emerald-500/40 transition-all duration-200 card-interactive shadow-sm"
                  >
                    <div className="h-10 w-10 rounded-xl bg-emerald-600 flex items-center justify-center mb-4 text-white shadow-sm group-hover:scale-105 transition-transform duration-200">
                    ...
                    <ChevronRight className="absolute top-4 right-4 h-4 w-4 text-content-muted group-hover:text-emerald-500 group-hover:translate-x-0.5 transition-all" />
                  </Link>
                );
              })}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="rounded-3xl border border-surface-border bg-surface-card p-7 shadow-sm">
              <div className="flex items-center justify-between mb-5">
                ...
                <Link to="/profile" className="text-xs text-emerald-500 hover:underline font-semibold flex items-center gap-1 transition-colors">
                  Edit <ArrowRight className="h-3.5 w-3.5" />
                </Link>
              </div>

              <div className="flex items-center gap-4 mb-5 pb-5 border-b border-surface-border">
                <div className="h-14 w-14 rounded-2xl bg-emerald-600 flex items-center justify-center text-xl font-black text-white shadow-sm shrink-0">
